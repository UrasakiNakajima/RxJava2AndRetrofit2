...
Java_com_phone_library_1base_JavaGetData_nativeAesKey(JNIEnv *env, jclass clazz, jobject context,
                                                        jboolean is_release) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_phone_library_1base_JavaGetData_nativeDatabaseEncryptKey(JNIEnv *env, jclass clazz,
                                                                    jobject context,
                                                                    jboolean is_release) {
    const char *signStrng = getSignString(env, context);
    bool isRelease = is_release;
