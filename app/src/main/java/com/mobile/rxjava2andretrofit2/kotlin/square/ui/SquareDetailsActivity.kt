...
import com.mobile.rxjava2andretrofit2.base.BaseMvvmAppActivity
import com.mobile.rxjava2andretrofit2.databinding.ActivitySquareDetailsBinding
...
//                    LogManager.i(TAG, "onChanged*****${t.toString()}")
    ...
    fun squareDetailsError(error: String) {
        if (!this.isFinishing()) {
            showCustomToast(ScreenManager.dipTopx(this, 20f), ScreenManager.dipTopx(this, 20f),
                    ...
                    resources.getColor(com.mobile.rxjava2andretrofit2.R.color.color_FFE066FF), ScreenManager.dipTopx(this, 40f),
    ...
    override fun onDestroy() {
        dataxDetails.title = null
        dataxDetails.chapterName = null
        dataxDetails.link = null
