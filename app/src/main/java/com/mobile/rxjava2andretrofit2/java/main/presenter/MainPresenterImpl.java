package com.mobile.rxjava2andretrofit2.java.main.presenter;
...
import com.mobile.rxjava2andretrofit2.java.main.model.MainModelImpl;
import com.mobile.rxjava2andretrofit2.java.main.presenter.base.IMainPresenter;
...
public class MainPresenterImpl extends BasePresenter<IBaseView>
    ...
    //    private IMineView mainView;//P需要与V 交互，所以需要持有V的引用
