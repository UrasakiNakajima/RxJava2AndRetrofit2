...
public class PictureToBase64TaskThread extends Thread {

    private static final String TAG = PictureToBase64TaskThread.class.getSimpleName();
    private String base64Str;
    private String filePath;
    private String txtFilePath = null;
    private List<String> base64StrList;

    public PictureToBase64TaskThread(String filePath) {
