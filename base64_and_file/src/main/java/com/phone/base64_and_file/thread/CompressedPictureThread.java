...
public class CompressedPictureThread extends Thread {

    private static final String TAG = CompressedPictureThread.class.getSimpleName();
    private Context context;
    private String dirsPath;
    private String dirsPath2;

    public CompressedPictureThread(Context context,
                                   String dirsPath,
                                   String dirsPath2) {
