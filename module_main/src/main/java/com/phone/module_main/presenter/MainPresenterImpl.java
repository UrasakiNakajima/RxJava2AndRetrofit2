...
//                                } else {
//                                    mainView.mainDataError(BaseApplication.instance().getResources().getString(R.string.library_data_in_wrong_format));
//                                }
...
//                                // 异常处理
//                                mainView.mainDataError(BaseApplication.instance().getResources().getString(R.string.library_request_was_aborted));
//                                mainView.hideLoading();
//                            }
//                        });
            }
