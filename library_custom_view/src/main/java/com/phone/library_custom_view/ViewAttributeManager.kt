package com.phone.library_custom_view
...
import com.phone.library_custom_view.custom_view.ColorUiInterface
...
object ViewAttributeManager {
    ...
    fun getCheckMarkAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.checkMark)
    }

    @JvmStatic
    fun getSrcAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.src)
    }

    @JvmStatic
    fun getTextApperanceAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.textAppearance)
    }

    @JvmStatic
    fun getDividerAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.divider)
    }

    @JvmStatic
    fun getTextColorAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.textColor)
    }

    @JvmStatic
    fun getTextLinkColorAttribute(attr: AttributeSet): Int {
        return getAttributeValue(attr, R.attr.textColorLink)
    }
