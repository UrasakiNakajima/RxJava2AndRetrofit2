...
public class MaterialVideoView extends LinearLayout
    ...
    private MineVideoView videoView;
    ...
    public MaterialVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.custom_view_material_video_layout, null);
        initView(view);
