package com.phone.library_custom_view.fragment
...
class EventScheduleDialogFragment :
    BaseBindingDialogFragment<CustomViewDialogFragmentEventScheduleBinding>() {
    ...
    private fun setSuccessView() {
        ...
        mRxAppCompatActivity?.let {
            val eventScheduleLayout =
                EventScheduleLayout(it, rowsDTOList)
    ...
    override fun initLayoutId(): Int = R.layout.custom_view_dialog_fragment_event_schedule
