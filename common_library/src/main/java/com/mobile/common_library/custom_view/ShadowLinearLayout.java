...
import com.mobile.common_library.manager.GlideRoundManager;
...
public class ShadowLinearLayout extends LinearLayout {
    ...
    public void setLayoutBackground(int color) {
        if (layoutBackground_true != null) {
            throw new UnsupportedOperationException("使用了ShadowLinearLayout_hl_layoutBackground_true属性，要与ShadowLinearLayout_hl_layoutBackground属性统一为颜色");
        }
    ...
    public void setLayoutBackgroundTrue(int color) {
        if (layoutBackground != null) {
            throw new UnsupportedOperationException("使用了ShadowLinearLayout_hl_layoutBackground属性，要与ShadowLinearLayout_hl_layoutBackground_true属性统一为颜色");
        }
    ...
    protected void onFinishInflate() {
        ...
        if (mTextViewResId != -1) {
            ...
            if (mTextView == null) {
                throw new NullPointerException("ShadowLinearLayout找不到hl_bindTextView，请确保绑定的资源id在ShadowLinearLayout内");
            } else {
                if (textColor == -101) {
        ...
        if (firstView == null) {
            firstView = ShadowLinearLayout.this;
