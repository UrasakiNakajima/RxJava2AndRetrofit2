...
public class RetrofitManager {
	 ...
	 * @return
	 */
	public Disposable responseString(AppCompatActivity activity, Observable<ResponseBody> observable, OnCommonSingleParamCallback<String> onCommonSingleParamCallback) {
		Disposable disposable = observable
									.onTerminateDetach()
									.subscribeOn(Schedulers.io())
									.observeOn(AndroidSchedulers.mainThread())
	 ...
	 * @return
	 */
	public Disposable responseString(Fragment fragment, Observable<ResponseBody> observable, OnCommonSingleParamCallback<String> onCommonSingleParamCallback) {
		Disposable disposable = observable
									.onTerminateDetach()
									.subscribeOn(Schedulers.io())
									.observeOn(AndroidSchedulers.mainThread())
