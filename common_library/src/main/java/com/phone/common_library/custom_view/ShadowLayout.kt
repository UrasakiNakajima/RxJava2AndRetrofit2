...
class ShadowLayout(context: Context) : FrameLayout(context) {
    ...
    fun setLayoutBackground(color: Int) {
        if (layoutBackground_true != null) {
            throw UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground_true属性，要与ShadowLayout_hl_layoutBackground属性统一为颜色")
        }
    ...
    fun setLayoutBackgroundTrue(color: Int) {
        if (layoutBackground != null) {
            throw UnsupportedOperationException("使用了ShadowLayout_hl_layoutBackground属性，要与ShadowLayout_hl_layoutBackground_true属性统一为颜色")
        }
