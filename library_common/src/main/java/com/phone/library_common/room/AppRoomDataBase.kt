...
//        val passphrase = SQLiteDatabase.getBytes("Aa456123".toCharArray())
...
//        }, true)
        ...
        @JvmStatic
        val DATABASE_NAME = "simple_app.db"
        @JvmStatic
        val DATABASE_ENCRYPT_NAME = "simple_encrypt_app.db"
        @JvmStatic
        val DATABASE_DECRYPT_NAME = "simple_decrypt_app.db"
