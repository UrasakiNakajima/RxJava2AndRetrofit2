...
public class ConstantUrl {
    ...
    public static final String SUB_RESOURCE_URL = "/wxarticle/list/{id}/{pageNum}/json";
    public static final String SUB_PROJECT_URL = "/project/list/{pageNum}/json";
    public static final String SQUARE_URL = "/article/listproject/{currentPage}/json";

    public static final String PROJECT_TAB_URL = "/project/tree/json";
    public static final String RESOURCE_TAB_URL = "/wxarticle/chapters/json";
