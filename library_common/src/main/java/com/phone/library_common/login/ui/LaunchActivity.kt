package com.phone.library_common.login.ui
...
//                val homePage = ARouter.getInstance().build(ConstantData.Route.ROUTE_HOME_PAGE)
//                    .navigation() as IHomePage
//                if (homePage != null && "Home".equals(homePage.mHomePage)){
//
//                }
//                val projectPage = ARouter.getInstance().build(ConstantData.Route.ROUTE_PROJECT_PAGE)
//                    .navigation() as IProjectPage
