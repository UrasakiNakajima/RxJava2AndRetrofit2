...
//import androidx.v4.view.KeyEventCompat;//API 26及其以下

public class LazyViewPager2 extends ViewGroup {

    private static final String TAG = LazyViewPager2.class.getSimpleName();
    ...
    public LazyViewPager2(Context context) {
        super(context);
        initViewPager();
    }

    public LazyViewPager2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     * layout there will be a smooth animated transition between the current item_historic_record and the
     * specified item_historic_record.
     *
     ...
     *
     * @param item         Item index to select
     * @param smoothScroll True to smoothly scroll to the new item_historic_record, false to transition immediately
     */
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (newPos == PagerAdapter.POSITION_NONE) {
                ...
                if (mCurItem == ii.position) {
                    // Keep the current item_historic_record in the valid range
            ...
            if (ii.position != newPos) {
                if (ii.position == mCurItem) {
                    // Our current item_historic_record changed position. Follow it.
                    newCurrItem = newPos;
                }
    ...
    void populate() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if ((ii.position < startPos || ii.position > endPos) && !ii.scrolling) {
                ...
                // The next item_historic_record is outside of our range, but we have a gap
                // between it and the last item_historic_record where we want to have a page
